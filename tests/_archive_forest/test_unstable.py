"""Tests for :func:`xenosite._archive_forest.unstable`."""
...
from xenosite._archive_forest.unstable import UnstableWarning, _warned, unstable
...
def test_path_outcome_unpack_and_helpers():
    from xenosite._archive_forest.guided_path import MaybeFilter, PathOutcome
