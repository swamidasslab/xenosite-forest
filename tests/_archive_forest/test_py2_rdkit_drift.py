...
from xenosite._archive_forest import PhaseOneRS, load_ruleset
from xenosite._archive_forest.base import can_smi
from xenosite._archive_forest.rules import QuinoneFormation
from xenosite._archive_forest.utils import clean
...
def test_rdkit_warnings_do_not_print_to_stderr():
    ...
    script = (
        "from rdkit import Chem\n"
        "from xenosite._archive_forest import PhaseOneRS\n"
