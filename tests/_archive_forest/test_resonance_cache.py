...
from xenosite._archive_forest import rulesets
...
from xenosite._archive_forest.rules import Dehydrogenation, Hydrogenation, Tautomerization
from xenosite._archive_forest.utils import refresh_mol, unmapped_smiles
...
def test_copy_mol_and_carry_forest_do_not_share_resonance_by_size():
    from xenosite._archive_forest.base import copy_mol, carry_forest
...
def test_install_product_forest_clears_resonance():
    from xenosite._archive_forest.base import install_product_forest, copy_mol
