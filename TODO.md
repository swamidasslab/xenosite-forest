...
- Later (optional): hardcode `canonical_emitted_sites=True` on flaky POC tests (topo / guided gold / path hard / unique-edit) if lex site identity helps — fuzz already draws the flip via Hypothesis
