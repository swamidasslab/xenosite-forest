...
from xenosite.forest.rdkitutil import Mol, TracingMol
from xenosite.forest.records import Addition, ProductInfo, TraceAddition
...
def reaction_labels(addition: Addition | TraceAddition) -> tuple[str, ...]:
    ...
    :class:`~xenosite.forest.records.Addition`. Both store the chain
