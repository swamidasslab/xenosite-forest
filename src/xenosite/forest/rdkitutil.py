...
``Formula`` is a dict. Callers use keys. :class:`~xenosite.forest.records.McsResult`
and :class:`~xenosite.forest.records.FragmentSplit` are NamedTuples.
...
from xenosite.forest.forest_copy import (
    copy_mutable,
    empty_forest,
    forest_copy,
    set_start_labels,
...
class XfTracing:
    """Atom-trace queries and plumbing for a parent :class:`~xenosite.forest.rdkit_api.Mol`.
    ...
    def _trace(
        ...
        from xenosite.forest.rules import _apply_forest_trace
