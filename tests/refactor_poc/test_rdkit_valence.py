...
from xenosite.refactor_poc.rdkitutil import run_reactants
from xenosite.refactor_poc.rules import Dehydrogenation, SmartsReactionRule, describe
...
def test_metabolites_continues_after_runreactants_runtime_error(monkeypatch):
    ...
    monkeypatch.setattr("xenosite.refactor_poc.rules.run_reactants", boom)
