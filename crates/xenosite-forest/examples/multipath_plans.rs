...
fn dump(name: &str, start: &str, target: &str) {
    ...
    println!(
        "hits={}  n_lin_sum={n_lin_sum}  same_lin_pairs={same_lin_pairs}  skeleton_pairs={skeleton_pairs}  nodes={}  mol_edits={}  drop_dup={}  signal_contained={}  deprio_site={}  plan_drops={}  wall={ms:.0} ms",
        hits.len(),
        counters.nodes,
        counters.mol_edits,
