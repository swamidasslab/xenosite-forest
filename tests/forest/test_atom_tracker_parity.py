...
from xenosite.forest.atom_tracker import AtomTracker as PocAtomTracker
from xenosite.forest.rules import Hydroxylation as PocHydroxylation
...
def test_atom_tracker_facade_emits_deprecation_warning():
    ...
    with warnings.catch_warnings(record=True) as caught:
        ...
        PocAtomTracker.topol_equiv(mol)
    assert any(
