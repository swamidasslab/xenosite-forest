...
from xenosite.forest.guided_path import CleavageSide, and_cleave_plan, _canon
from xenosite.forest.path_context import PathContext, formula_compatible
from xenosite.forest.rules import Dealkylation, Hydrolysis, Hydroxylation
from xenosite.forest.step_plan import And, StepPlan
...
def test_and_cleave_plan_independent_preps_become_and_then_seq():
    ...
    from xenosite.forest.step_plan import AtomRef, Deps
    ...
    from xenosite.forest.guided_path import _canonical_plan_key
